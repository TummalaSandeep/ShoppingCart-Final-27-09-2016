...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<div class="container">
        ...
        <img src="<c:url value="/resources/images/sandy1.JPG"/>" alt="Chania" width="300" height="200">
      </div>

      <div class="item">
        <img src="<c:url value="/resources/images/sandy2.jpg"/>" alt="Chania" width="300" height="200">
      </div>
    
      <div class="item">
        <img src="<c:url value="/resources/images/sandy3.jpg"/>" alt="Chania" width="300" height="200"> 
      </div>
